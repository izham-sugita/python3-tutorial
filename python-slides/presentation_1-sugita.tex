...
\title[Short title]{Sharing Research Experience: What Does It Take To Be Proficient In Theoretical Research} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\medskip
\textit{izham@unimap.edu.my} % Your email address
}
